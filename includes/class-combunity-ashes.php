...
class Combunity_Ashes {
	...
	/**
	 * Check if no theme is enabled.
	 * 
	 * returns true if no theme is enabled.
	 * returns false if theme is enabled.
	 */
	public function notheme(){
		return apply_filters( 'combunity_notheme' , true );
	}
	...
	private function load_dependencies() {
		...
		/**
		 * Setup internal Combunity Pages for Edit/Delete
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-combunity-ashes-internal-pages.php';			

		/**
		 * The Frontend class builds and renders the frontend.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-combunity-ashes-frontend.php';
		...
		$this->Frontend = new Combunity_Ashes_Frontend( $this );

		$this->Pages = new Combunity_Ashes_Internal_Page_Handler( $this );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Combunity_Ashes_Public( $this->get_Combunity_Ashes(), $this->get_version(), $this );
